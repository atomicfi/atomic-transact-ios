Pod::Spec.new do |s|
    ...
    s.license = { :type => 'Copyright', :text => '© Copyright 2026 Atomic FI Inc.'}
    ...
    s.subspec 'AtomicTransact' do |ss|
        ...
        ss.dependency "AtomicSDK/Uplink"
        ss.ios.deployment_target = '15.0'
    end

    s.subspec 'Uplink' do |ss|
        ss.vendored_frameworks = "artifacts/Uplink.xcframework"
